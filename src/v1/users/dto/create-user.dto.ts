...
import { USER_PROVIDERS, USER_ROLES } from "src/v1/users/constant";

export class CreateUserDto {
  @IsOptional()
  @IsUUID(null, { message: "유저 식별자는 UUID 형태만 입력이 가능합니다." })
  id?: string;
  ...
  @IsOptional()
  @IsUUID(null, { message: "이미지 식별자는 UUID 형태만 입력이 가능합니다." })
  imageId?: string;
}
